...
RUN mkdir -p /app/data /app/users /var/log/gunicorn && \
    chown -R tronbyt:tronbyt /app/data /app/users /var/log/gunicorn && \
    chmod -R 755 /app/data /app/users /var/log/gunicorn
